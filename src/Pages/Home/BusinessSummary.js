...
const BusinessSummary = () => {
	return (
		<div  className=' my-32'>
			...
			<div data-aos="fade-right" data-aos-anchor-placement="center-bottom" className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-10 justify-items-center gap-5'>
